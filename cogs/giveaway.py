...
if not os.path.isfile("giveaways.json"):
    sys.exit("'giveaways.json' not found! Add it and try again.")
else:
    with open("giveaways.json") as file:
...
class Giveaways(commands.Cog):
    ...
    @commands.has_permissions(administrator=True, owner=True)
    ...
    @commands.command(name="reroll", description="Rerolls a giveaway for a new winner. !reroll (id of the giveaway message)")
    @commands.has_permissions(administrator=True, owner=True)
