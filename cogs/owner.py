...
class Owner(commands.Cog, name="owner"):
    ...
    @blacklist.command(name="add", description="Add a user to blacklist i.e. revoke a user's access to the server")
    @commands.is_owner()
    ...
    @blacklist.command(name="remove", description="Add a user to blacklist i.e. revoke a user's access to the server")
    @commands.is_owner()
