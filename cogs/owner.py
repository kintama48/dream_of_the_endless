...
class Owner(commands.Cog, name="owner"):
    ...
    # shut the bot down
    @commands.command(name="shutdown", description="Shut the bot down")
    ...
    # shows the blacklist
    @commands.group(name="blacklist", description="Show the blacklist")
    @commands.has_permissions(administrator=True)
    ...
    @commands.command(name="add-blacklist", description="Add a user to blacklist i.e. revoke a user's access to the server")
    @commands.has_permissions(administrator=True)
    ...
    @commands.command(name="remove-blacklist", description="Remove a user from blacklist i.e. unrevoke a user's access to the server")
    @commands.has_permissions(administrator=True)
    async def blacklist_remove(self, context, member: discord.Member = None):
        if context.message.author.id in config["owners"]:
            userID = member.id
            try:
                remove_user_from_blacklist(userID)
                embed = discord.Embed(
